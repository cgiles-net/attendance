<?php 
  ...
  $ucp_nav->add_item("<a href='?view=portals'$dajax class='ui-icon-home ui-nodisc-icon ui-alt-icon' style='padding-left: 1.5em;'></span>Home</a>");
  $ucp_nav->add_item("Edit My Profile");
